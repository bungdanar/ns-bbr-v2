...
ggplot() +
  ...
  xlab("Time(s)") +
  ylab("Delay(s)") +
  ggtitle("Delay-BBR vs Cubic 10Mbps 10ms") +
  ylim(0, 0.5) +
  scale_colour_manual("",
                      breaks = c("Delay-BBR", "Cubic", "Flow Three", "Flow Four"),
                      values = c("green", "blue", "red", "purple" ))
Data <- read.table("~/Documents/BBRv2-Eval-ns-3/results/TcpBbr/OneFlowCubic/11-04-2020-07-28-27-BBR_DELAY10Mbps-40ms-1.500000vsCubic/delay.data")
FlowOne <- data.frame(matrix(ncol=2, nrow=length(Data$V1[Data$V2 == 3])))
FlowOne$X1 <- Data$V1[Data$V2 == 3]
FlowOne$X2 <- Data$V3[Data$V2 == 3]
FlowOne$X2 <- gsub("ns", "", FlowOne$X2)
...
ggplot() +
  ...
  xlab("Time(s)") +
  ylab("Delay(s)") +
  ggtitle("Delay-BBR vs Cubic 10Mbps 40ms") +
  ylim(0, 0.5) +
  scale_colour_manual("",
                      breaks = c("Delay-BBR", "Cubic", "Flow Three", "Flow Four"),
                      values = c("green", "blue", "red", "purple" ))
Data <- read.table("~/Documents/BBRv2-Eval-ns-3/results/TcpBbr/OneFlowCubic/11-04-2020-07-35-55-BBR_DELAY10Mbps-100ms-1.500000vsCubic/delay.data")
FlowOne <- data.frame(matrix(ncol=2, nrow=length(Data$V1[Data$V2 == 3])))
FlowOne$X1 <- Data$V1[Data$V2 == 3]
FlowOne$X2 <- Data$V3[Data$V2 == 3]
FlowOne$X2 <- gsub("ns", "", FlowOne$X2)
...
ggplot() +
  ...
  xlab("Time(s)") +
  ylab("Delay(s)") +
  ggtitle("Delay-BBR vs Cubic 10Mbps 100ms") +
  ylim(0, 0.5) +
  scale_colour_manual("",
                      breaks = c("Delay-BBR", "Cubic", "Flow Three", "Flow Four"),
                      values = c("green", "blue", "red", "purple" ))